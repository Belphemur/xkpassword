...
namespace XkPassword
{
    ...
    public class XkPasswd
    {
        ...
        public XkPasswd()
        {
            this.DictionaryLanguage = LanguageFactory.Lang.English;
        ...
        /// <summary>
        /// Easy way to set the the choose an embedded dictionary
        /// </summary>
        public LanguageFactory.Lang DictionaryLanguage
        {
            set => WordListPath = (new LanguageFactory()).GetValue(value).FileName;
        }
